...
import com.msc.libcommon.util.AnimationUtils;
import com.msc.libcommon.util.ThemeUtils;
 ...
 */
@ViewPager.DecorView
public class CumTabLayout extends HorizontalScrollView {
    ...
    public CumTabLayout(Context context) {
        this(context, null);
    }

    public CumTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CumTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        void setIndicatorPosition(int left, int right) {
            if (left != mIndicatorLeft || right != mIndicatorRight) {
                ...
                if (mIndicatorRight - mIndicatorLeft > 30) {
                    int i = ((mIndicatorRight - mIndicatorLeft - 30) / 2);
                    mIndicatorLeft = mIndicatorLeft + i;
                    mIndicatorRight = mIndicatorRight - i;
                }
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<CumTabLayout> mTabLayoutRef;
        private int mPreviousScrollState;
        private int mScrollState;

        public TabLayoutOnPageChangeListener(CumTabLayout tabLayout) {
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            final CumTabLayout tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
